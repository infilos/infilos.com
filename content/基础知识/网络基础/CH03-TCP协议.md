...
> TCP协议是一种面向连接的、可靠的、基于字节流的**全双工**运输层通信协议。
...
关于这个算法实现，你可以参看Linux源码：[/net/ipv4/tcp_vegas.h (opens new window)](http://lxr.free-electrons.com/source/net/ipv4/tcp_vegas.h)， [/net/ipv4/tcp_vegas.c](http://lxr.free-electrons.com/source/net/ipv4/tcp_vegas.c)
