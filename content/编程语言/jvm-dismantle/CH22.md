---
type: docs
title: "CH22-HotSpot-intrinsic"
linkTitle: "CH22-HotSpot-intrinsic"
weight: 22
---
...
这是因为**高效实现通常依赖于具体的 CPU 指令，而这些 CPU 指令不好在 Java 源程序中表达。再者，换了一个体系架构，说不定就没有对应的 CPU 指令，也就无法进行 intrinsic 优化了**。
