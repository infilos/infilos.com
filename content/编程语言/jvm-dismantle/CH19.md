...
type: docs
title: "CH19-字节码基础"
linkTitle: "CH19-字节码基础"
weight: 19
---

## 操作数栈

我们知道，**Java 字节码是 Java 虚拟机所使用的指令集**。因此，它**与 Java 虚拟机基于栈的计算模型是密不可分的**。

**在解释执行过程中，每当为 Java 方法分配栈桢时，Java 虚拟机往往需要开辟一块额外的空间作为操作数栈，来存放计算的操作数以及返回结果**。

具体来说便是：**执行每一条指令之前，Java 虚拟机要求该指令的操作数已被压入操作数栈中**。**在执行指令时，Java 虚拟机会将该指令所需的操作数弹出，并且将指令的结果重新压入栈中**。

<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303225254.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303225254" /></div>

以加法指令 iadd 为例。假设在执行该指令前，栈顶的两个元素分别为 int 值 1 和 int 值 2，那么 iadd 指令将弹出这两个 int，并将求得的和 int 值 3 压入栈中。

<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303225312.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303225312" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303225757.png" style="display:block;margin-left:auto;margin-right:auto;width:80%;" alt="20220303225757" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303225910.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303225910" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303225954.png" style="display:block;margin-left:auto;margin-right:auto;width:80%;" alt="20220303225954" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230112.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303230112" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230135.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303230135" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230151.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303230151" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230205.png" style="display:block;margin-left:auto;margin-right:auto;width:80%;" alt="20220303230205" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230223.png" style="display:block;margin-left:auto;margin-right:auto;width:80%;" alt="20220303230223" /></div>
