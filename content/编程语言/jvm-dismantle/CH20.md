...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230519.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303230519" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230534.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303230534" /></div>

### **bar 方法的 IR 图**

接下来，即时编译器便可以进行方法内联，把 bar 方法所对应的 IR 图纳入到对 foo 方法的编译中。具体的操作便是将 foo 方法的 IR 图中 5 号 Invoke 节点替换为 bar 方法的 IR 图。

<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230548.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303230548" /></div>
...
<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230611.png" style="display:block;margin-left:auto;margin-right:auto;width:60%;" alt="20220303230611" /></div>

该 IR 图可以进一步优化（死代码消除），并最终得到这张极为简单的 IR 图：

<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230623.png" style="display:block;margin-left:auto;margin-right:auto;width:30%;" alt="20220303230623" /></div>
...
最后，即**时编译器将根据方法调用指令所在的程序路径的热度，目标方法的调用次数及大小，以及当前 IR 图的大小来决定方法调用能否被内联**。

<div><img src="https://infi-img.oss-cn-hangzhou.aliyuncs.com/img/20220303230643.png" style="display:block;margin-left:auto;margin-right:auto;width:80%;" alt="20220303230643" /></div>
